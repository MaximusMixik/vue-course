<template>
	<div>
		<radio-filter title="Продавці" :items-list="sellersObjList" v-model="filterValue.seller" />
		<checkbox-filter title="Бренди" :items-list="brandsObjList" v-model="filterValue.brands" />
	</div>
</template>
